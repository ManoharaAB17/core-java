package com.xworkz.servlet.jan_26_WebSeris;
...
@WebServlet(loadOnStartup = 1, urlPatterns = "/jan")
public class WebSerisServlet extends HttpServlet {
	public WebSerisServlet() {
