...
public class Ghost {
	...
	@Autowired
	public Ghost(@Qualifier("gname") String name, @Qualifier("gfatherName") String fatherName,
			@Qualifier("gmotherName") String motherName, @Qualifier("gdateOfBirth") LocalDate dateOfBirth,
			@Qualifier("gdateOfDeath") LocalDate dateOfDeath, @Qualifier("gyoungerSisterName") String youngerSisterName,
			@Qualifier("gelderSisterName") String elderSisterName,
			@Qualifier("gyoungerBrotherName") String youngerBrotherName,
